...
# 
# for(i in c(0:4)){
#   y1 <- read.csv(paste0("data/a_new_hope_batch", i+1, "/Y1.csv")) %>%
#     mutate(model = "1")
#   
#   y2 <- read.csv(paste0("data/a_new_hope_batch", i+1, "/Y2.csv")) %>%
#     mutate(model = "2")
#   
...
#   
#   meta_data <- read.csv(paste0("data/a_new_hope_batch", i+1, "/meta_data.csv")) %>%
...
# 
# write.csv(performance_data, file = "data/a_new_hope_performance.csv")
```

# load data

```{r}
performance_data <- read.csv("data/a_new_hope_performance.csv")
```
