...
for run in range(10):
    for strength in ["0.0", "0.5", "1.0"]:
        r1 = pd.read_csv(f"data/unequal/r1_cs={strength}_r1=500_r2=500_sample=0.5_inequality=0.2_sim={run}.csv")
        r2 = pd.read_csv(f"data/unequal/r2_cs={strength}_r1=500_r2=500_sample=0.5_inequality=0.2_sim={run}.csv")
...
summary_df.to_csv("data/unequal/avg_PCA_variance.csv", index=False)
