...
write.csv(cum_var_df, "data/savedata/cumulative_explained_var_r1=500_r2=500_sample=0.5.csv", row.names = FALSE)
```
...
```{r}
cum_var_df <- read.csv("data/savedata/cumulative_explained_var_r1=500_r2=500_sample=0.5.csv") %>%
