...
class CesnModel:
    def __init__(self, r1_nnodes=None, r2_nnodes=None, coupling_strength=None):

        self.coupling_strength = coupling_strength
        self.reservoir1 = Reservoir(units=r1_nnodes, sr=0.9, lr=0.1, activation='tanh') # seed=42
        self.reservoir2 = Reservoir(units=r2_nnodes, sr=0.9, lr=0.1, activation='tanh') # seed=42
    ...
    def test(self, input=None, target=None, noise=None, do_print=False, save_reservoir=False):
        Y_pred1 = []
        Y_pred2 = []
        R_states1 = []
        R_states2 = []
